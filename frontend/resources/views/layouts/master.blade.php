...
<html lang="en">
    ...
    <body>
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="/dashboard">Present App</a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            @elseif (session()->get('auth')['role'] == 'lecturer')
                ...
                <div class="modal-body">
                    ...
                    @else
                        <div class="text-center">
                            <h3><i class="fa fa-trash"></i> Delete User? <i class="fa fa-trash"></i></h3>
                        </div>
                    @endif
                </div>
